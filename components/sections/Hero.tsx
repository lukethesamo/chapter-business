      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <span className="text-sm font-medium text-primary">Trusted by 150+ UK Universities</span>
          </motion.div>
          ...
          >
            Reach{' '}
            <span className="gradient-text">1M+ UK Students</span>
            <br />
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">Join 500+ businesses</span>
            </div>
